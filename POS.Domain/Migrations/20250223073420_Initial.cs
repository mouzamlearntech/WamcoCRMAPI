        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityPurchased = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    QuantityDamaged = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    QuantitySoldReturned = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    QuantityPurchasedReturned = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    QuantityAdjusted = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    QuantityToTransfter = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    QuantityFromTransfter = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DailyStockDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousTotalStock = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    DamagedStockId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
