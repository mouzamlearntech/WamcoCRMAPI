...
namespace POS.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var res = Configuration.GetSection("AllowCors").Value;
            ...
            //var allowedOrigins = Configuration.GetSection("AllowCors").Get<string[]>();
            services.AddCors(options =>
            {
                options.AddPolicy("ExposeResponseHeaders",
                    builder =>
                    {
                        builder.WithOrigins("https://crmapi.wamcoautomations.com",
                          "https://crm.wamcoautomations.com",
                          "http://crmapi.wamcoautomations.com",
                          "http://crm.wamcoautomations.com",
                        "http://localhost:4200")
