...
namespace POS.Repository
{
    public class PropertyMappingService : IPropertyMappingService
    {
       ...
       new Dictionary<string, PropertyMappingValue>(StringComparer.OrdinalIgnoreCase)
       {
        ...
        private Dictionary<string, PropertyMappingValue> _dailyStockPropertyMapping =
         new Dictionary<string, PropertyMappingValue>(StringComparer.OrdinalIgnoreCase)
         {
                { "Id", new PropertyMappingValue(new List<string>() { "Id" } ) },
                { "LastUpdateDate", new PropertyMappingValue(new List<string>() { "LastUpdateDate" }, true )},
                { "DailyStockDate", new PropertyMappingValue(new List<string>() { "DailyStockDate" },true )},
                { "ClosingStock", new PropertyMappingValue(new List<string>() { "ClosingStock" } )},
                { "OpeningStock", new PropertyMappingValue(new List<string>() { "OpeningStock" } )},
                { "QuantityAdjusted", new PropertyMappingValue(new List<string>() { "QuantityAdjusted" } )},
                { "QuantityDamaged", new PropertyMappingValue(new List<string>() { "QuantityDamaged" } )},
                { "QuantityFromTransfter", new PropertyMappingValue(new List<string>() { "QuantityFromTransfter" } )},
                { "QuantityPurchased", new PropertyMappingValue(new List<string>() { "QuantityPurchased" } )},
                { "QuantityPurchasedReturned", new PropertyMappingValue(new List<string>() { "QuantityPurchasedReturned" } )},
                { "QuantitySold", new PropertyMappingValue(new List<string>() { "QuantitySold" } )},
                { "QuantitySoldReturned", new PropertyMappingValue(new List<string>() { "QuantitySoldReturned" } )},
                { "QuantityToTransfter", new PropertyMappingValue(new List<string>() { "QuantityToTransfter" } )},
                { "Product", new PropertyMappingValue(new List<string>() { "Product.Name" } )},
                { "Location", new PropertyMappingValue(new List<string>() { "Location.Name" } )}
        ...
        public PropertyMappingService()
        {
            ...
            propertyMappings.Add(new PropertyMapping<DailyStockDto, DailyStock>(_dailyStockPropertyMapping));
        }
